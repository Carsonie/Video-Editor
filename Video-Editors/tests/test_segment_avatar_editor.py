...
def s_ask_claude_box():
    ...
    # .claude/ lives at the REPO root, not beside the code. The 2026-09-04
    # restructure moved the editors down into Video-Editors/ so Customers/
    # could sit beside them; .claude/ stayed put, because a skill only
    # registers at the project root and would have gone silently invisible.
    skill = os.path.join(fixture.REPO, ".claude", "skills",
