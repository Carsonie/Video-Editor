...
# fixture.REPO and fixture.CODE_ROOT were THE SAME FOLDER until 2026-09-04,
# when the editors moved down into Video-Editors/ so Customers/ could sit
# beside them. They are now different:
#   fixture.REPO       the repo root — Customers/ and .claude/ live here
#   fixture.CODE_ROOT  Video-Editors/ — Sarah/, cache/ and the editors
...
def s_common_library():
    ...
    check("its path is real, resolved against Sarah/ — not Customers/",
          os.path.isfile(os.path.join(fixture.CODE_ROOT, "Sarah", sample["path"])),
          sample["path"])
...
def s_libs_group_order():
    ...
    serve_src = open(os.path.join(fixture.CODE_ROOT, "avatar_editor", "serve.py")).read()
    ...
    sarah_dir = os.path.join(fixture.CODE_ROOT, "Sarah")
